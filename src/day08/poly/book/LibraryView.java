    ...
    private static void selectMenu() {
        ...
        switch (menuNum) {
            ...
            case "4":
                ...
                RentStatus rentStatus = repository.rentBook1(Integer.parseInt(rentNum));
...
//                repository.rentShowBook();
//                int userNum = Integer.parseInt(input("# 대여할 도서 번호 입력 : "));
//                System.out.println(repository.rentBook(userNum));
                break;
            case "5":
                String authorKeyword = input("# 저자: ");
                ArrayList<Book> bookArrayList = repository.searchAuthorInfoList(authorKeyword);
                if(!bookArrayList.isEmpty()){
                    for (Book book : bookArrayList) {
                        System.out.println(book.info() + " 저자 : " + book.getAuthor() );
                    }
                } else{
                    System.out.println("\n# 검색 결과가 없습니다.");
                }
